var e={};const t=new URL(e=import.meta.resolve("jwRx5"));var r={};const n=new URL(r=import.meta.resolve("jZyf0"));var a={};const i=new URL(a=import.meta.resolve("kVl1L")),o={data:{game:{playerMove:"",computerMove:"",playerVictories:0,computerVictories:0,draws:0,roundWinner:"",retry:!1}},listeners:[],getState(){return this.data},setState(e){let t=this.getState();for(let t of(this.data=e,this.listeners))t();localStorage.setItem("player_victories",JSON.stringify(t.game.playerVictories)),localStorage.setItem("computer_victories",JSON.stringify(t.game.computerVictories))},suscribe(e){this.listeners.push(e)},computerMove(){let e=Math.floor(3*Math.random()),t=this.getState();t.game.computerMove=["piedra","papel","tijera"][e],this.setState(t)},result(){let e=this.getState();"piedra"==e.game.playerMove&&"tijera"==e.game.computerMove||"papel"==e.game.playerMove&&"piedra"==e.game.computerMove||"tijera"==e.game.playerMove&&"papel"==e.game.computerMove?(e.game.playerVictories+=1,e.game.roundWinner="player"):"piedra"==e.game.playerMove&&"papel"==e.game.computerMove||"papel"==e.game.playerMove&&"tijera"==e.game.computerMove||"tijera"==e.game.playerMove&&"piedra"==e.game.computerMove||""==e.game.playerMove?(e.game.computerVictories+=1,e.game.roundWinner="computer"):(e.game.draws+=1,e.game.roundWinner="draw"),o.setState(e)},initStorage(){let e=this.getState(),t=JSON.parse(localStorage.getItem("player_victories"))||0,r=JSON.parse(localStorage.getItem("computer_victories"))||0;e.game.playerVictories=t,e.game.computerVictories=r,this.setState(e)}},s=new URL(e),l=new URL(r),d=new URL(a);class c extends HTMLElement{constructor(){super(),this._timer=3;let e=this.attachShadow({mode:"open"}),t=document.createElement("div");t.classList.add("container");let r=document.createElement("style");r.innerHTML=`
        .container{
            display: flex;
  ...
  <start-component></start-component>
  `,r}!function(){o.initStorage();class e extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),r=document.createElement("div"),a=document.createElement("style");a.innerHTML=`
    ...
    .start_btn__container{
      ...
      `;let s=r.querySelector(".first_text"),l=r.querySelector(".first_text"),d=r.querySelector(".second_text"),c=r.querySelector(".play_btn__container"),p=r.querySelector(".before_play_container");s?.addEventListener("click",e=>{e.stopPropagation(),l.style.display="none",d.style.display="flex"}),c?.addEventListener("click",t=>{t.stopPropagation(),p.style.display="none";let r=document.createElement("div");r.innerHTML=`  
    ...
    `;let a=r.querySelector(".btn_container");a?.addEventListener("click",e=>{t.game.retry=!0,t.game.roundWinner="",t.game.computerMove="",t.game.playerMove="",o.setState(t)}),e.appendChild(n),e.appendChild(r)}}customElements.define("score-board",s);var l=document.querySelector(".root");let d=[{path:/\/home/,handler:x},{path:/\/result/,handler:y}];function c(e){history.pushState({},"",e),v(e)}function v(e){for(let t of d)if(t.path.test(e)){let e=t.handler({goTo:c});l.firstChild&&l.firstChild.remove(),l.appendChild(e)}}window.addEventListener("load",()=>{c("/home")}),"/"==location.pathname?c("/home"):v(location.pathname)}();
//# sourceMappingURL=ppt.5ca9b881.js.map
